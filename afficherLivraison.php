      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <a href="livraison - Ajout.html" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-plus-circle"></i> </i>  Ajouter un livraison</a></div>
          <!-- Content Row -->
          <!-- Content Row -->
          <div class="row">
            <!-- Area Chart -->
...
foreach($listeLivraisons as $row){
	...
	<td><a href="modifierLivraison.php?id=<?PHP echo $row['ID']; ?>"><i class="fas fa-pen" style="color:black"></i>
	</a></td>
	</tr>
	</tbody>
	<?PHP
