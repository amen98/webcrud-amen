...
if (isset($_GET['id'])){
	...
	foreach($result as $row){
		$id=$row['ID'];
		$transp=$row['TRANSPORTEUR'];
		$dest=$row['DESTINATION'];
		$adr=$row['ADRESSE'];
		$delais=$row['DELAIS'];
		$codeC=$row['CODE_COMMANDE'];
		$frais=$row['FRAIS'];
?>
<form method="POST">
<table>
...
<tr>
<td>Transporteur</td>
<td><input type="number" name="transp" value="<?PHP echo $transp ?>" class="form-control form-control-user"  width="30%"></td>
</tr>
<tr>
<td>Destination</td>
<td><select class="form-control form-control-user"  width="30%"  size="1" name="dest">
...
<tr>
<td>Adresse</td>
<td><input type="text" name="adr" value="<?PHP echo $adr ?>" class="form-control form-control-user"  width="30%"></td>
</tr>
<tr>
<td>Delais</td>
<td><input type="number" name="delais" value="<?PHP echo $delais ?>" class="form-control form-control-user"  width="30%"></td>
</tr>
<tr>
<td>Code Commande</td>
<td><input type="number" name="codeC" value="<?PHP echo $codeC ?>" class="form-control form-control-user"  width="30%"></td>

</tr>
<tr>
<td>Frais de livraison</td>
<td><input type="number" name="frais" value="<?PHP echo $frais ?>" class="form-control form-control-user"  width="30%"></td>
</tr>
<tr>
<td></td>
...
if (isset($_POST['modifier'])){
	$livraison=new livraison($_POST['id'],$_POST['transp'],$_POST['dest'],$_POST['adr'],$_POST['delais'],$_POST['codeC'],$_POST['frais']);
